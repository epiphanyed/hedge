...
if (config.menmen.blockRoutes === undefined) {
  config.menmen.blockRoutes = process.env.CMD_MENMEN_BLOCK_ROUTES !== 'false'
}
if (config.menmen.customUI === undefined) {
  config.menmen.customUI = process.env.CMD_MENMEN_CUSTOM_UI !== 'false'
}
menmenPerm.initFromConfig(config)
