...
module.exports = {
  ...
  oauth2: {
    ...
    userProfileAvatarAttr: process.env.CMD_OAUTH2_USER_PROFILE_AVATAR_ATTR,
  ...
  menmen: {
    mysqlUrl: process.env.CMD_MENMEN_MYSQL_URL,
    homeUrl: process.env.CMD_MENMEN_HOME_URL,
    blockRoutes: toBooleanConfig(process.env.CMD_MENMEN_BLOCK_ROUTES),
    customUI: toBooleanConfig(process.env.CMD_MENMEN_CUSTOM_UI),
    assetVersion: process.env.CMD_MENMEN_ASSET_VERSION || '2026082503'
  },
  manim: {
    serviceUrl: process.env.CMD_MANIM_SERVICE_URL || 'http://manim-service:8000',
    serviceToken: process.env.CMD_MANIM_SERVICE_TOKEN
  }
}
